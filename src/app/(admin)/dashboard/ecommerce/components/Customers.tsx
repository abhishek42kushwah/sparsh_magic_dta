...
const Customers = () => {
  ...
  const chartOptions: ApexOptions = {
    ...
    labels: ['total Users', 'Orders Purchas', 'Orders Not Purchas'],
  ...
  return (
    <Card>
      ...
      <CardBody className="pt-0">
        {seriesData.length > 0 && seriesData.some(val => val > 0) ? (
          <>
            ...
            <div className="bg-light py-3 px-2 mb-0 mt-2 text-center rounded">
              <h6 className="mb-0">
                <i className="icofont-calendar fs-5 me-1" /> 01 Nov  to 30 Nov 
              </h6>
            </div>
